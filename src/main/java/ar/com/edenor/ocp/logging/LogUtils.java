...
public class LogUtils {
    ...
    public static void putSecurityAccessErrorLogToMDC(String errorCode, String errorDescription, String edenorIntegrationName, String responseCode, String sourceSystem) {
        MDC.put("target",SPLUNK_TARGET);
        MDC.put("integrationName",edenorIntegrationName);
